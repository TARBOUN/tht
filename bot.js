...
const prefix = "2"; // البرافيكس
   const GUILDID = '774809527845126165'; // اي دي السيرفر  
   const CHANNELID = '774820507815378966'; // اي دي الروم
...
client.on('ready', () => {
  console.log(`Logged in as ${client.user.tag}!`);
   client.user.setActivity(" ALWAYS AND FOREVER❤  ",{type: 'STREAMING'})
});

const { Client } = require('discord.js');
const ytdl  = require('ytdl-core'); // by : MeTuBe Plus
const url = 'https://youtu.be/stOxwoZeu9w'; // هنا فديو الخاص ب القرأن الكريم كامل 
